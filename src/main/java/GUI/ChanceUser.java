 ...
 * @author jukut
 */
public class ChanceUser extends javax.swing.JFrame {
    ...
    public ChanceUser() throws Exception {

    }

    public ChanceUser(User us) {
        try {
            UIManager.setLookAndFeel(new FlatLightLaf());
            initComponents();
            iduser = us.getUserId();
            txtusername.setText(us.getUserName());
            txtFullName.setText(us.getNickname());
            pwPassword.setText(us.getPassword());
            jPasswordField2.setText(us.getPassword());
            us.getSex();
            if (us.getSex() == 0) {
                ...
                rdAnother.setSelected(true);
            }
            DateChooser.setDate(us.getBirthday());
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        btnchance.setBackground(new java.awt.Color(242, 242, 242));
        btnchance.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Chane.png"))); // NOI18N
        btnchance.setText("Chance");
        btnchance.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(88, 88, 88))
                            .addComponent(DateChooser, javax.swing.GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(57, 57, 57)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txterro, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnchance, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(176, 176, 176))
        );
    ...
    private void btnchanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnchanceActionPerformed
        try {
            ...
            if (g == 0) {
                ...
                String msg = "ChanceUser-1;" + user.getUserId() + ";" + user.getUserName() + ";" + user.getPassword() + ";" + user.getNickname() + ";" + user.getSex() + ";" + startDateString;
                byte[] encryptedMsg = client.cc.symmetricEncryption(msg);
                client.push(encryptedMsg);
            }
        } catch (Exception ex) {
            Logger.getLogger(ChanceUser.class.getName()).log(Level.SEVERE, null, ex);
        }
